...
Forecasting using an `ardl` model is simple, using the `predict.ardl()` function.

```{r Predict-ardl}
# Create new observations
new_values <- zoo(data.frame(
        LRY=c(6.073861, 6.069912, 6.075906, 6.081180, 6.938292),
...
predicted_values <- predict.ardl(ardl_3132, new_values)
```
