...
Forecasting using an `ardl` model is simple with the `predict()` function, which dispatches to `predict.ardl()`, a method created specifically for these models in this package.
