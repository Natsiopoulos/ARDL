...
`ARDL` creates complex ARDL models providing just the order and automatically constructs the underlying unrestricted and restricted ECM. It also performs the bounds-test for cointegration and provides the multipliers and the cointegrating equation.
